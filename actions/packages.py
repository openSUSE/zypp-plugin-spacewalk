...
def setLocks(package_list, cache_only=None):
    ...
    os.write(tmpf, '# Generated by zypp-plugin-spacewalk:packages.setLocks action\n')
    os.write(tmpf, '# Do not edit! Changes will be lost!\n')
    for pkg in package_list:
        # pkg is a tuple (n, v, r, e, a)
        os.write(tmpf, '\n')
        os.write(tmpf, 'type: package\n')
        os.write(tmpf, 'match_type: exact\n')
        os.write(tmpf, 'case_sensitive: on\n')
        os.write(tmpf, 'solvable_name: %s\n' % pkg[0])
    os.close(tmpf)
